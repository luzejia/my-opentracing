...
func handler(w http.ResponseWriter, r *http.Request) {
        fmt.Println("start to call on C")
	...
	req, err := http.NewRequest("GET", "http://service-c:80/", nil)
	if err != nil {
		fmt.Println(err)
	}
        ...
        //req.Header.Add("X-B3-Parentspanid", r.Header.Get("X-B3-Spanid"))
        req.Header.Add("X-B3-Parentspanid", r.Header.Get("Upstream-Spanid"))
        req.Header.Add("Upstream-Spanid", r.Header.Get("X-B3-Spanid"))
        //req.Header.Add("X-B3-Parentspanid", "aaaaaaaaaaaaaaaa")
        //req.Header.Add("X-B3-Spanid", "bbbbbbbbbbbbbbbb")
